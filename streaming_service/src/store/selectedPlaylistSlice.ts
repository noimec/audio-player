...
export const { setCurrentPlaylist, setViewedPlaylist } =
  selectedPlaylistSlice.actions;

export const selectCurrentPlaylist = (state: RootState) =>
  state.selectedPlaylist.currentPlaylist;
export const selectViewedPlaylist = (state: RootState) =>
  state.selectedPlaylist.viewedPlaylist;
